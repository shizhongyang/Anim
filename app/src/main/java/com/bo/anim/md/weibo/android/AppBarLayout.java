...
import static com.bo.anim.md.weibo.android.ViewUtils.objectEquals;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.MyScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(
                    R.styleable.MyScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
        ...
        @Override
        protected AppBarLayout findFirstDependency(List<View> views) {
