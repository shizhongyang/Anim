package com.bo.anim.customviewgroup.viewpage;
...
import com.bo.anim.custom.MyScrollView;
...
public class WelcompagerTransformer implements PageTransformer, OnPageChangeListener {
	 ...
	 *
	 */
	@Override  //position 为0代表这个页面滑动到当前页面  -1代表滑动在左侧，1在右侧
