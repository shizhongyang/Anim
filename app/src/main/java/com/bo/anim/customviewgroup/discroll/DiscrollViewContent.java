package com.bo.anim.customviewgroup.discroll;
...
public class DiscrollViewContent extends LinearLayout {
	...
	@Override  //在addView里面会调用这个方法，将我们自定义的属性传入 这样就可以得到params
	...
	public void addView(View child, int index,
		...
		if(!isDiscrollvable(p)){
			...
			//在addView里面插一脚，往child外面包裹一层FrameLayout 让这个外层的View来
			// 拿到里面的属性  交给自己就是外层包裹View
