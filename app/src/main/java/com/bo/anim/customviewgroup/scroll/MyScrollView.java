package com.bo.anim.customviewgroup.scroll;
...
public class MyScrollView extends ScrollView {
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if(listener!=null){
			...
			if(scrollY<=screen_height/3f){//0~1f,��͸����Ӧ����1~0f
				listener.onTranlucent(1-scrollY/(screen_height/3f));//alpha=����ȥ�ĸ߶�/(screen_height/3f)
			}
		}
	}
